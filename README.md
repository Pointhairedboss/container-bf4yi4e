...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-bf4yi4e.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-bf4yi4e.containers.anotherwebservice.com/
...
```
git clone git@github.com:Pointhairedboss/container-bf4yi4e.git
cd container-bf4yi4e
```
...
```
docker attach container-bf4yi4e
```
